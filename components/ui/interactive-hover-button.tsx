...
>(({ text = "Button", className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      {...props}
    >
      <span className="inline-block translate-x-1 rtl:-translate-x-1 transition-all duration-300 group-hover:translate-x-12 rtl:group-hover:-translate-x-12 group-hover:opacity-0 relative z-20">
        {text}
      </span>
      <div className={cn(
