  ...
  return (
    <section id="hero" className="relative h-screen min-h-[700px] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="glass p-6 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[3rem] max-w-6xl w-full border border-white/30 dark:border-white/10 shadow-2xl relative overflow-hidden group backdrop-blur-md transition-colors duration-500">
          ...
          <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8 opacity-40 pointer-events-none">
            ...
            <div className="relative w-20 h-20 md:w-32 md:h-32">
              <svg viewBox="0 0 100 100" className="w-full h-full">
                <polygon points="50,10 90,90 10,90" fill="none" stroke="currentColor" strokeWidth="2" className="text-squared-cyan/60 dark:text-squared-cyan/40" />
                <polygon points="50,25 75,75 25,75" fill="none" stroke="currentColor" strokeWidth="2" className="text-squared-navy/60 dark:text-white/20" />
              </svg>
            </div>
          </div>
          ...
          <div className="absolute bottom-4 right-4 md:bottom-8 md:right-8 opacity-40 pointer-events-none">
            ...
            <div className="relative w-16 h-16 md:w-24 md:h-24">
              ...
              <div className="absolute top-0 right-0 w-8 h-8 md:w-12 md:h-12 border-2 border-squared-navy/60 dark:border-white/20 rounded-sm"></div>
            </div>
          </div>
          ...
          <div className="absolute top-4 left-4 md:top-8 md:left-8 opacity-40 pointer-events-none">
            ...
            <div className="relative w-20 h-20 md:w-28 md:h-28">
              <div className="absolute inset-0 bg-gradient-to-br from-squared-cyan/20 to-squared-navy/20 dark:from-squared-cyan/10 dark:to-black/30 backdrop-blur-sm rounded-sm"></div>
              <div className="absolute inset-0 border-2 border-squared-cyan/40 rounded-sm"></div>
              <div className="absolute top-2 right-2 w-8 h-8 md:w-12 md:h-12 bg-squared-navy/30 dark:bg-white/10 backdrop-blur-sm rounded-sm"></div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6">
              ...
              <a
                href="#locations"
                className={`w-full sm:w-auto group cursor-pointer glass dark:bg-white/5 text-squared-brown-dark dark:text-white px-8 md:px-10 py-3 md:py-4 rounded-full text-xs md:text-sm font-black uppercase tracking-[0.2em] shadow-xl border border-white/40 dark:border-white/10 hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-500 hover:-translate-y-1 ${language === 'ar' ? 'font-arabic tracking-normal' : ''}`}
              >
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-pulse opacity-30">
        <ArrowDown className="w-8 h-8 text-squared-brown-dark dark:text-white transition-colors" />
      </div>
    </section>
  );
};
