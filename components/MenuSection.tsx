      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          <div className="w-full lg:w-1/4 min-w-0">
            <div className="sticky top-24 md:top-32 glass p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] shadow-warm border border-white/30 overflow-x-auto md:overflow-hidden overflow-y-visible relative group flex items-center md:block" style={{ WebkitOverflowScrolling: 'touch', touchAction: 'pan-x' }}>
              ...
              <div className="flex flex-row md:flex-col items-center md:items-start gap-4 md:overflow-visible pb-0 md:pb-0 w-full">
